...
public class TestConfig {
    ...
    /** 管理员账号 — 优先从环境变量读取 */
    public static final String ADMIN_USER = System.getenv().getOrDefault("TAAS_USER", "admin");
    public static final String ADMIN_PWD  = System.getenv().getOrDefault("TAAS_PASS", "Aa123456");
