...
public class CustomAttributeApiTest extends BaseTest {
    ...
    void test_addCustomAttributeEmptyNameEn() {
        ...
        Assertions.assertNotEquals(200, code,
                "空英文名应被拦截, 实际code=" + code + ", resp: " + resp);
    ...
    void test_addCustomAttributeEmptyName() {
        ...
        try {
            ...
            int code = root.get("code").getAsInt();
            Assertions.assertNotEquals(200, code,
                    "空中文名应被拦截, 实际code=" + code + ", resp: " + resp);
    ...
    void test_addCustomAttributeDuplicateNameEn() {
        ...
        try {
            ...
            int code = root.get("code").getAsInt();
            Assertions.assertNotEquals(200, code,
                    "重复英文名应被拦截, 实际code=" + code + ", resp: " + resp);
    ...
    void test_deleteCustomAttributeInvalid() {
        ...
        int code = root.get("code").getAsInt();
        Assertions.assertNotEquals(200, code,
                "删除不存在的属性应失败, 实际code=" + code + ", resp: " + resp);
