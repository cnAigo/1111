...
const deleteEnvironment = async (environment) => {
  try {
    ...
    await api.delete(`/api/api-testing/environments/${environment.id}/`)
...
const activateEnvironment = async (environment) => {
  try {
    await api.post(`/api/api-testing/environments/${environment.id}/activate/`)
...
const duplicateEnvironment = async (environment) => {
  ...
  try {
    await api.post('/api/api-testing/environments/', newEnv)
...
const submitForm = async () => {
  ...
  try {
    ...
    if (editingEnvironment.value) {
      await api.patch(`/api/api-testing/environments/${editingEnvironment.value.id}/`, data)
      ElMessage.success(t('apiTesting.messages.success.environmentUpdated'))
    } else {
      await api.post('/api/api-testing/environments/', data)
