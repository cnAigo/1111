<template>
  <div class="dashboard-container">
    ...
    <div class="stats-section">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-card shadow="hover" class="stat-card clickable" @click="goToProjects">
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="stat-card clickable" @click="goToInterfaces">
            <div class="stat-content">
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="stat-card clickable" @click="goToAutomation">
            <div class="stat-content">
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="stat-card clickable" @click="goToHistory">
            <div class="stat-content">
...
// 导航到各功能页面
const goToProjects = () => {
  router.push('/api/api-testing/projects')
}

const goToInterfaces = () => {
  router.push('/api/api-testing/interfaces')
}

const goToAutomation = () => {
  router.push('/api/api-testing/automation')
}

const goToHistory = () => {
  router.push('/api/api-testing/history')
}

const goToEnvironments = () => {
  router.push('/api/api-testing/environments')
}

const goToReports = () => {
  router.push('/api/api-testing/reports')
}
