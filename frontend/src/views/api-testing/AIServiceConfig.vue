...
const loadConfigs = async () => {
  loading.value = true
  try {
    const res = await api.get('/api/api-testing/ai-service-configs/')
...
const saveConfig = async () => {
  ...
  try {
    if (editingConfig.value) {
      await api.patch(`/api/api-testing/ai-service-configs/${editingConfig.value.id}/`, form)
      ElMessage.success(t('apiTesting.aiServiceConfig.messages.updateSuccess'))
    } else {
      await api.post('/api/api-testing/ai-service-configs/', form)
...
const deleteConfig = async (id) => {
  try {
    ...
    await api.delete(`/api/api-testing/ai-service-configs/${id}/`)
...
const testConnection = async (config) => {
  ...
  try {
    await api.post(`/api/api-testing/ai-service-configs/${config.id}/test_connection/`)
